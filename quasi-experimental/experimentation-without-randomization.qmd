...
A common pattern to these studies is the separation of a single "before" evaluation into multiple "before" evaluations and a similar separation of a single "after" evaluation into multiple "after" evaluations.
