...
The prefix "quasi" implies inferiority. In fact, a prominent research (Campbell 1988) calls them "queasy" experiments. This, however, is an unfair characterization.
...
You have multiple evaluations before the intervention, give the intervention to everyone and then make multiple evaluations after the intervention.

The thing you are hoping for is a flat pattern during the multiple evaluations before the intervention, a sudden jump right at the intervention, and a flat pattern for all the evaluations after the intervention. In contrast an upward (or downward) trend at each and every evaluation is very strong negative evidence.

If you detect a slope or trend prior to the intervention, things get a bit more complicated. Look for either a jump at the intervention but also look for a change in slope. Either a flattening of a negative trend or an acceleration of an already positive trend is good news for your intervention.

A study of poor compliance with clear aligner therapy (Timm 2022) monitored patients biweekly in 2019 prior to the introduction of a system of electronic reminders and feedback. Monitoring continued throughout all of 2020. The second half of 2019 was compared to the second half of 2020, to avoid problems with start-up and with seasonality. The rate of poor compliance was flat during the second half of 2019, hovering around 25%. The data showed a downward trend in the second half of 2020, leveling off at a much better value of 9% in October 2020. The authors concluded that electronic reminders and feedback effectively reduced poor compliance rates.
...
You are hoping for a flat-jump-flat-jump-flat pattern. Outside influences might cause a consistent trend up or down, or it might cause a single sudden jump, but it would be very unusual for something to cause a flat-jump-flat-jump-flat pattern.
...
There is no easy answer to how many evaluation points you might need. If your data is noisy, you might need quite a few evaluation points. Even without a lot of noise, you want enough evaluation points to identify and rule out any cyclic patterns. For monthly evaluations, a couple of years would be nice so you can factor out seasonality. For daily evaluations, a couple of weeks so you can rule out any "Hump Day" or "Thank God It's Friday" effects.

The interesting issue is that when you increase the number of measurement times, you may be able to reduce the number of patients. The pattern observed in the single self-biting patient is quite revealing. This is an example of an "n of 1" design (Davidson 2020), where changes correspond precisely to the times when the intervention is added (or removed). 

## A different problem to addressed
...
If you have multiple clinics, split the intervention timing up so that some of the clinics get the intervention early, some at an intermediate time and some closer to the end of the study. This is a stepped wedge design.

You are looking jumps at the times when an intervention occurs, but only in the affected clinics. Clinics that got the intervention earlier or later, you hope that they show a flat pattern instead.
